...
parser.add_argument("--timeout", help="timeout for snmp connection", type=int, default=30)
parser.add_argument("--retries", help="retries for snmp connection if timeout occurs", type=int, default=1)
